...
function getAll_Apartments() {
  ...
  return all.filter(p => p.type && p.type.toLowerCase().includes("квартира"));
}
...
function applyFilters() {
  const houses = getAll_Apartments();
  ...
  page.forEach((h, i) => {
    ...
    card.innerHTML = `
      <div class="card-img-wrap">
        ...
        <div class="card-badges"><span class="badge badge-type">Квартира</span></div>
